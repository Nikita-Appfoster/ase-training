...
<html lang="en">
  ...
  <body>
    ...
    <div class="d-flex justify-content-end">
        <a href="<?php echo e(url('/homepage')); ?>" class="btn btn-dark btn-sm active mt-3" role="button" aria-pressed="true" style="margin-right: 160px;">Back</a>
    </div>
    ...
    <div class="d-flex justify-content-center align-items-center">
        <div class="container">
            <div class="mt-3 d-flex justify-content-center">
                <a href="#" class="btn btn-primary btn-sm active" role="button" aria-pressed="true">Add New User</a>
            </div>
            ...
            <div class="d-flex justify-content-center mt-2">
                <form style="width: 50%" action="<?php echo e(url('/adduserinfo')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\91706\backend-api-laravel\resources\views//users/addnewuser.blade.php ENDPATH**/ ?>